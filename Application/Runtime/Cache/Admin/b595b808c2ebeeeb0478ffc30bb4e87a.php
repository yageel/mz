...
<div id="wrapper">
      ...
      <ul class="nav" id="side-menu">
        ...
        <li> <a href="#"> <i class="fa fa-object-group"></i> <span class="nav-label">设备管理</span> <span class="fa arrow"></span> </a>
          <ul class="nav nav-second-level">
            <li> <a class="J_menuItem" href="<?php echo U('/device/index');?>">设备列表</a> </li>
          </ul>
        </li>

        <li> <a href="#"> <i class="fa fa-credit-card"></i> <span class="nav-label">套餐管理</span> <span class="fa arrow"></span> </a>
          <ul class="nav nav-second-level">
            <li> <a class="J_menuItem" href="<?php echo U('/package/index');?>">套餐列表</a> </li>
          </ul>
        </li>

        <li> <a href="#"> <i class="fa  fa-balance-scale"></i> <span class="nav-label">角色管理</span> <span class="fa arrow"></span> </a>
          <ul class="nav nav-second-level">
            <li> <a class="J_menuItem" href="<?php echo U('/user/index');?>">角色列表</a> </li>
          </ul>
        </li>

        <li style=" border-bottom: 2px solid #ccc!important;"> <a href="#"> <i class="fa fa-gamepad"></i> <span class="nav-label">佣金管理</span> <span class="fa arrow"></span> </a>
          <ul class="nav nav-second-level">
            <li> <a class="J_menuItem" href="<?php echo U('/rebate/index');?>">佣金列表</a> </li>
          </ul>
        </li>
        ...
        <li style=" border-bottom: 2px solid #ccc!important;"> <a href="#"> <i class="fa fa-money"></i> <span class="nav-label">系统设置</span> <span class="fa arrow"></span> </a>
          <ul class="nav nav-second-level">
            <li> <a class="J_menuItem" href="<?php echo U('city/index');?>">公众号设置</a> </li>
  ...
  <div id="page-wrapper" class="gray-bg dashbard-1">
    ...
    <div class="footer">
      <div class="pull-right">&copy; 2015-2016 <a href="http://www.millionmake.com/" target="_blank">魔座</a> </div>
    </div>
  </div>
  <!--右侧部分结束-->
  <!--右侧边栏开始-->
