...
(function () {
    ...
    // 游戏计时结束
    function timeOver() {
        tools.ajax(tools.url("active", "redrain_gameresult3"), {
            uuid: actUId,
            id: actSubId
        }, function (ret) {
            if (ret.state == 10) {
                ...
                tools.alert(sessionData.msg, function () {
                    if(wishcard_show ==1){
                      //显示卡牌
                    	...
                    	//跳到结算页
                        location.href = tools.url("active", "redrain_settlement3", { uuid: actUId, id: actSubId });
                    }
                });
              //卡牌小图更新
        ...
        return function (type) {
            ...
            icon.touchstart = function (e) {
                ...
                if (gameState == 1) {
                    ...
                    tools.ajax(tools.url("active", "redrain_winred3"), {
