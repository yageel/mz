...
(function () {
    ...
    function addGameObj() {
        var rdNumber = Math.random(),
            obj = new gameObject(rdNumber > .80 ? "goods" : rdNumber > .7 ? "red" : "gold");
    ...
    // 游戏计时结束
    function timeOver() {
    	tools.ajax(tools.url("active_redrain", "redrain_gameresult"), {
            uuid: actUId,
            id: actSubId
    	}, function (ret) {
    	    if (ret.state == 10) {
    	        ...
    	        tools.alert(sessionData.msg, function () {
                    //跳到结算页
                    location.href = tools.url("active_redrain", "redrain_settlement", { uuid: actUId, id: actSubId });
                });
    	    } else {
        ...
        return function (type) {
            ...
            icon.touchstart = function (e) {
                ...
                if (gameState == 1) {
                    ...
                    tools.ajax(tools.url("active_redrain", "redrain_winred"), {
