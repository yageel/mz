...
class WxPayDataBase
{
	...
	**/
	...
	public function MakeSign()
	{
		...
		//签名步骤二：在string后加入KEY
            Log::DEBUG('handle-result-MakeSign-WXPAY.KEY-'.c('WXPAY.KEY'));
        Log::DEBUG('handle-result-MakeSign-'.WxPayConfig::$KEY);
 ...
 *
 */
class WxSendHongBao extends WxPayDataBase
{
    /**
     * 红包单号
     * @param string $value
 ...
 *
 */
class WxSendPay extends WxPayDataBase
{
    /**
     * 红包单号
     * @param string $value
